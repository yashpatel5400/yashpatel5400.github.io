...
\includevideo{https://youtu.be/EYgh6XcLpA0}
\begin{figure*}
  \caption{CPO leverages informative, non-convex conformal prediction regions for robust predict-then-optimize decision making. CPO uses a score function such that the resulting prediction regions can be decomposed into convex subregions over which optimization can be carried out efficiently.
  }
\end{figure*}
